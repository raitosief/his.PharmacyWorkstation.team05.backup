				...
				<el-container class="down">
					<el-main style="align-items: center;">
						<el-form class="my-add" style="width: 100%; ">
							...
							<el-form-item label="药 品 I D" style="width: 45%;">
								<el-input type="text" v-model="drugs.id" disabled="true"></el-input>
							</el-form-item>
							<el-form-item label="药品编码" style="width: 45%;">
								<el-input type="text" v-model="drugs.drugsCode" disabled="true"></el-input>
							</el-form-item>
							<el-form-item label="药品剂型" style="width: 45%;">
								<el-input type="text" v-model="drugs.drugsDosageID"></el-input>
							</el-form-item>
							<el-form-item label="药品规格" style="width: 45%;">
								<el-input type="text" v-model="drugs.drugsFormat"></el-input>
							</el-form-item>
							<el-form-item label="药品名称" style="width: 45%;">
								<el-input type="text" v-model="drugs.drugsName"></el-input>
							</el-form-item>
							<el-form-item label="药品价格" style="width: 45%;">
							...
							<el-form-item label="助记编码" style="width: 45%;">
							...
							<el-form-item>
								<el-button type="primary" class="btn-center" @click='doUpdate()' color="#1F4FA3">更新</el-button>
							</el-form-item>
...
<script setup>
	...
	const drugs = ref(JSON.parse(route.query.u));
