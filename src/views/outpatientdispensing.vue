		...
		<el-container>
			...
			<el-container>
				<el-aside style="border-right: 1px solid #aaaaaa;">
					<div>
						<br /><br /><br />
						<el-link type="default" style="font-size:x-large" @click='tooutpatientdispensing()' disabled>发药 </el-link><br /><br />
					...
					<el-main>
						<el-form class="my-query" style="width: 100%; align-items: center;">
							...
							<el-table :data="tableData" stripe border class="el-table" height="400" style="width: 96%; margin: auto; align-items: center;">
								...
								<el-table-column prop="amount" label="药品数量" width="100"></el-table-column>
								...
								<el-table-column fixed="right" label="操作" width="300">
									<template #default="scope">
										<el-button type="danger" @click='doUpdate(scope.row)'>确认发药</el-button>
